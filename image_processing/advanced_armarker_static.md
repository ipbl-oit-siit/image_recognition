```markdown
### 🟥 AR Marker Generation (`ipB_generateARmarker.py`)
...
To create a marker, select a predefined dictionary (a set of marker patterns) and specify a unique marker ID along with the output pixel size.
...
### 🟨 Exercise: Complete the Overlay Program (`ipB_detectARmarker.py`)
